...
namespace Sdwru\Awx\Adapter\Connector;
...
final class GuzzleConnector implements ConnectorInterface
{
     ...
     * @param string[] $config
     *
     * @return \AwxV2\Adapter\GuzzleHttpAdapter
     */
    ...
    private static function getConfig(array $config)
    {
        ...
        return Arr::only($config, ['token', 'sslVerify']);
    }
    ...
    {
        return new GuzzleHttpAdapter($config['token'], $config['sslVerify']);
    }
}
